...
from arms.cores.MassEntity.msentity.io.msp import *
...
# %%
from arms.cores.MassEntity.msentity.core.PeakCondition import *
peak_condition = IntensityThreshold(threshold=0.01) & TopKIntensity(k=100)
filter_ms_dataset = ms_dataset.filter(peak_condition)
filter_ms_dataset

# %%
from arms.cores.MassEntity.msentity.core.SpecCondition import *
...
# %%
sorted_ms_dataset['IonMode'].unique()
